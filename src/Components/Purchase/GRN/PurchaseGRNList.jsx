  ...
  return (
    <>
      <div className="my-[1vw]">
        {addGrn === false ? (
          <div className="flex items-center justify-end my-[1vw]">
            <button
              className="bg-[#323232] text-white px-[1vw] py-[0.25vw] rounded-[0.25vw]"
              onClick={() => setAddGrn(true)}
            >
              Add GRN
            </button>
          </div>
          ...
          <>
            {!grnData || grnData.length === 0 ? (
              ...
              <>
                ...
                <div className="h-[50vh] overflow-y-scroll scrollbar-hide py-[0.5vw]">
                  {" "}
                        ...
                        hidden_details: (
                          <div className="flex justify-between">
                            ...
                            <div className="flex gap-[1vw]">
                              <button
                                className=" flex items-center justify-center cursor-pointer text-[0.8vw] px-[0.5vw] py-[0.2vw] bg-[#323232] text-white rounded-[0.25vw] gap-[0.25vw]"
                                onClick={() => {
                                  setAddGrn(true);
                                  setCaptureId(items?.GRNNum);
                                }}
                              >
                                <span>
                                  <VscEdit />
                              ...
                              <button
                                className="cursor-pointer text-[0.8vw] px-[0.5vw] py-[0.2vw] bg-[#323232] text-white rounded-[0.25vw]"
                                onClick={() => {
                                  setActiveTab("BillEntry");
                                  setCaptureId(items?.GRNNum);
                                }}
                              >
                                BillEntry
                        ...
                        <div className="border-[0.1vw] border-[#0A0E0D4D] p-[0.25vw] rounded-[0.5vw] my-[0.5vw]">
                          <div className="flex items-center justify-between px-[1vw] my-[1vw]">
                            ...
                            <div className="flex gap-x-[1vw] justify-between">
                              ...
                              <span className="text-[0.8vw] text-black">
                                {" "}
                                {dayjs(items?.ReceivedDate).format(
                                  "DD-MM-YYYY"
                                )}
                                {/* 20 Jun 2025 */}
                              </span>
      ...
      >
        <DeleteList
          ...
          title={`Want to delete this ${purchaseGrnData?.GRNNum}`}
          api={`${apiUrl}/purchasegrn/${purchaseGrnID}`}
          module={"GRN"}
          // filter={filter}
