    ...
    },
    {
      ...
      render: (row) => {
        ...
        {row?.ContactPersonName ? (
                      <p className="text-[0.85vw]">
                        {row?.ContactPersonName?.length > 12 ? (
                          <Tooltip
                            placement="top"
                            color="white"
                            overlayInnerStyle={{ color: "#0A0E0D" }}
                            title={`${capitalizeFirstLetter(row?.ContactPersonName)}`}
                            className="cursor-pointer"
                          >
                            {capitalizeFirstLetter(row?.ContactPersonName?.slice(0, 12)) +
                              ".."}
                          </Tooltip>
                        ) : (
                          capitalizeFirstLetter(row?.ContactPersonName)
                        )}
                      </p>
                    ) : (
                      <div className="font-bold text-[1vw] w-full">-</div>
