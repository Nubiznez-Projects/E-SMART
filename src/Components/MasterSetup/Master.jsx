...
import { fetchFilteredSupplier, fetchSuppliers } from "../../Redux/Slice/MasterModule/Suppliers/SupplierThunks";
import ExportButton from "../Common/Export/ExportButton";
import { SubmitSupplierExcel } from "../../API/MasterModule/Supplier";
import { SubmitCustomerExcel } from "../../API/MasterModule/Customer";
...
const applyFilters = (fromDate, toDate, status) => {
  ...
  const handleExcelSubmit = async (file) => {
    ...
    try {
      let response;
      if(tabName === "Supplier"){
      response = await SubmitSupplierExcel(file);
      dispatch(fetchSuppliers());
      } else{
      response = await SubmitCustomerExcel(file);
