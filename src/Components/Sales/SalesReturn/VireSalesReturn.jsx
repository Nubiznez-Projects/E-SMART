...
export const ViewSalesReturn = ({
  ...
  console.log("View Return Purchase :", salesReturnData);
  return (
    <>
          ...
          <div className="border-[0.1vw] border-[#3232327e] rounded-[0.5vw] px-[1vw] py-[0.5vw] bg-white     drop-shadow-md">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center text-[1.1vw]">
                ...
                <span>
                  {dayjs(salesReturnData?.CreatedDate).format("DD-MM-YYYY")}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-[2vw] gap-y-[0.5vw] mt-[1vw]">
              <div className="flex items-center justify-between">
                ...
                <span className=" text-[0.9vw]">
                  {salesReturnData?.SPoReturnID}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-[1vw]">Invoice Number :</span>
                <span className=" text-[0.9vw]">
                  {salesReturnData?.InvoiceNo}
                </span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className=" text-[0.9vw]">
                  {salesReturnData?.ContactPersonName}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-[1vw]">Email :</span>
                <span className=" text-[0.9vw]">
                  {salesReturnData?.Email}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-[1vw]">
                ...
                <span className=" text-[0.9vw]">
                  {salesReturnData?.MobileNumber}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-[1vw]">Return Date :</span>
                <span className=" text-[0.9vw]">
                  {dayjs(salesReturnData?.ReturnDate).format("DD-MM-YYYY")}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2 mt-[1vw]">
              <div className="flex justify-between text-[0.95vw]">
                ...
                <span className="font-medium">
                  {salesReturnData?.TotalItems}
                </span>
              </div>
              <div className="flex justify-between text-[0.95vw]">
                <span className="text-gray-600">Total Quantity:</span>
                <span className="font-medium">
                  {salesReturnData?.TotalQuantity}
                </span>
              </div>
              <div className="flex justify-between text-[1vw] font-bold py-[1vw] border-t border-gray-200">
                <span>Total Amount:</span>
                <span>INR {salesReturnData?.TotalAmount?.toFixed(2)}</span>
              </div>
            </div>
          </div>
        </div>
